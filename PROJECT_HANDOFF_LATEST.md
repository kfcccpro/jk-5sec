...
> 새 채팅 복구용 최우선 문서
> 시작 문구: `JK 5초 다음 작업 진행`, `다음 단계 진행`, 또는 `진행`
...
- PART 1 / CHAPTER 2 / UNIT 1~3
- 각 lesson 파생문항 5개
- 현재 총 50문항

다음:
- PART 1 / CHAPTER 2 / UNIT 4 `형용사 보어가 필요한 동사`

## 3. CHAPTER 2 · UNIT 3 저자식 판단

근거: 교재 PART 1 / CHAPTER 2 / UNIT 3, p.33.
분석 문서: `docs/PHASE22_CH2_UNIT3_ANALYSIS.md`

핵심:
1. M/T/B/F/C = make / think / believe / find / consider
2. 이 동사들이 5형식에서 긴 to-V 또는 that절을 목적어로 취하면 긴 목적어를 뒤로 이동
3. 목적어 자리에 가목적어 `it`
4. `it` 뒤에는 목적격보어, 대표적으로 형용사
5. 목적격보어 뒤의 to-V 또는 that절이 진목적어
...
1. 교재 p.34 저자식 판정 규칙 분석
2. 전용 decisionSchema 정의
3. 파생 연습문항 작성
4. runtime lesson 11 엔진 구현
5. CH 2 · UNIT 4 공통 Shell 등록
6. syntax + semantic CI 통과

사용자가 `JK 5초 다음 작업 진행`, `다음 단계 진행`, 또는 `진행`이라고 입력하면 최신 main/handoff/status/version/actions를 확인한 뒤 Phase 23부터 진행한다.
